...
/**
 * A binary operator with numeric operands
 */
public abstract class BooleanSymbolExpression implements BooleanExpression {

    public NumericExpression lhs;
    public NumericExpression rhs;

    public BooleanSymbolExpression(NumericExpression lhs, NumericExpression rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }

    public BooleanSymbolExpression() {
